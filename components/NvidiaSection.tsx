...
const NvidiaSection: React.FC = () => {
  return (
    <div className="py-24 md:py-32 bg-black relative overflow-hidden">
      {/* NVIDIA Green Glows */}
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#76b900] opacity-10 blur-[150px] rounded-full pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#76b900] opacity-5 blur-[120px] rounded-full pointer-events-none"></div>
      
      {/* Grid Pattern */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#76b90010_1px,transparent_1px),linear-gradient(to_bottom,#76b90010_1px,transparent_1px)] bg-[size:40px_40px] opacity-20 pointer-events-none"></div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/2">
            <motion.div 
              ...
              viewport={{ once: true }}
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#76b900]/10 border border-[#76b900]/20 text-[#76b900] text-xs font-bold uppercase tracking-widest mb-6"
            >
            ...
            >
              Next-Gen Inference with <span className="text-[#76b900]">NemoTRON</span>
            </motion.h2>
            ...
            <div className="grid grid-cols-2 gap-6">
              {[
                ...
                <motion.div 
                  ...
                  className="bg-white/5 border border-white/10 rounded-xl p-4 hover:border-[#76b900]/50 transition-colors group"
                >
                  <div className="flex items-center gap-3 mb-2">
                    <stat.icon size={18} className="text-[#76b900]" />
                    <span className="text-gray-400 text-xs uppercase tracking-wide">{stat.label}</span>
                  </div>
                  <div className="text-2xl font-bold text-white group-hover:text-[#76b900] transition-colors">{stat.value}</div>
